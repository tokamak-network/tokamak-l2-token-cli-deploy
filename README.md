...
- L1 rpc : https://sepolia.infura.io/v3/XXX
- L2 rpc : https://rpc.titan-sepolia-test.tokamak.network/`
...
> `cli l2-usdc-l1-l2-bridge-deploy -r1 https://sepolia.infura.io/v3/XXX -r2 https://rpc.titan-sepolia-test.tokamak.network/ -n 'New Titan' -m1 0xa94B847AAc9F00f10dA2F5c476408Fd5477D7d49 -l1u 0x693a591A27750eED2A0e14BC73bB1F313116a1cb -a2 0xc1eba383D94c6021160042491A5dfaF1d82694E6 -p 0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80`
>

you can see deployed contract addresses
```jsx
{
