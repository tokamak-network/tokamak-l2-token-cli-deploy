...
const { linkLibraries } = require("../utils/linkLibraries");
...
class UsdcBridgeDeployer {
    ...
    static async setL1Bridge(
      ...
      const L1UsdcBridgeProxy = new ethers.Contract(
        l1UsdcBridgeAddress,
    ...
    static async deployBridgedUsdc(
      ...
      if (ownerAddress == null || ownerAddress == undefined || ownerAddress == "0x0000000000000000000000000000000000000000") {
        ...
        const fiatToken = new ethers.Contract(FiatTokenProxy.address, artifacts.FiatTokenV2_2.abi, actor)
    ...
    async deployL1UsdcBridgeProxy(implementation) {
      ...
      const ContractInstance = new ethers.ContractFactory(
        ...
        this.deployer);
      const contractInstance = await ContractInstance.deploy(implementation, deployerAddress, '0x');
